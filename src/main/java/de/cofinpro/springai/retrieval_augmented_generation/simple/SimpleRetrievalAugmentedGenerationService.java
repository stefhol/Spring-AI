...
public class SimpleRetrievalAugmentedGenerationService extends AbstractRetrievalAugmentedGenerationService {
    ...
    public SimpleRetrievalAugmentedGenerationService(AzureOpenAiChatClient openAiChatClient, EmbeddingClient embeddingClient, @Value("classpath:/bikes.json") Resource bikesResource, @Value("classpath:/system-prompt-template") Resource systemPromptTemplateResource) {
